...
//  Remind
//
//  Created by Станислав Коцарь on 19.04.2018.
...
class UNService: NSObject {
    ...
    func timerRequest (with interval: TimeInterval) {
        ...
        let request = UNNotificationRequest(identifier: "userNotifaction.timer",
                                            content: content,
                                            trigger: trigger)
    ...
    func dateRequest (with components: DateComponents) {
        ...
        let request = UNNotificationRequest(identifier: "userNotifaction.date", content: content, trigger: trigger)
    ...
    func locationRequest () {
        ...
        content.body = "Wellcome back you silly coder you!"
        content.sound = .default()
        content.badge = 1
